					...
					class h extends HTMLElement {
						constructor() {
							super(),
								...
								(this.onTouchStart = (t) => {
									(this.handle && !s(this.handleElement, t)) || ((this.touchStartPoint = a(t)), (this.enableTransition(), this.slideToPage(this.touchStartPoint)));
								}),
								(this.onTouchMove = (t) => {
						...
						connectedCallback() {
							this.hasAttribute("tabindex") || (this.tabIndex = 0),
								...
								this.closest(".need-animate.animated") ? this.startAnimation() : null,
							...
							const wrapper = this.closest(".image-compare-new__wrapper");

							if (wrapper && wrapper.classList.contains("need-animate")) {
						...
						setExposure(t = 0) {
							let e;
							(this.exposure = ((e = this.exposure + t) < 0 ? 0 : e > 100 ? 100 : e)), this.firstElement.style.setProperty("--exposure", 100 - this.exposure + "%");
						}
